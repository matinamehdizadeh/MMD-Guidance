...
@torch.no_grad()
def convsample_ddim(model, F_M_Samples=None, F_M_real=None, steps=50, shape=None, eta=1.0, guidance_scale=0.0):
    ddim = DDIMSampler(model)
    bs = shape[0]
    shape = shape[1:]
    samples, intermediates, F_M_Samples = ddim.sample(steps, F_M_Samples, F_M_real, batch_size=bs, shape=shape,
                                                      eta=eta, verbose=False, guidance_scale=guidance_scale)
    return samples, intermediates, F_M_Samples
...
def make_convolutional_sample(model, F_M_Samples=None, F_M_real=None, batch_size=1, vanilla=False,
    ...
    with model.ema_scope("Plotting"):
        ...
        if vanilla:
            ...
            sample, intermediates, F_M_Samples = convsample_ddim(model, F_M_Samples, F_M_real,
                                                                  steps=custom_steps, shape=shape,
